...
mp_limb_t refmpn_addadd_n __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_srcptr yp, 
											mp_srcptr zp, mp_size_t n));
int refmpn_addsub_n __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_srcptr yp, 
											mp_srcptr zp, mp_size_t n));
